...
function EleventhSection() {
  const midCards = [
    {
      link: "/your-link-url",
      imageSrc: "https://media.zenfs.com/en/aol_cnn_articles_945/c929bd679202154c9359de6b3527b315",
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap bg-black">
        ...
        <div className="w-full md:w-2/5 p-4 text-white">
        ...
        {/* Third Column (1 part)  NOTE WORKING IMG*/}
      </div>
