...
function TenthSection() {
  const midCards = [
    {
      link: "/your-link-url",
      imageSrc: "https://www.tutorialspoint.com/windows10/images/user_accounts_screen.jpg",
      text: "Windows Users Didn't Know This Simple Trick To Block All Ads (Do It Now)",
      horizontal: true,
    },
    {
      link: "/your-link-url",
      imageSrc: "https://images.mansionglobal.com/im-77815721",
    ...
    {
      link: "/your-link-url",
      imageSrc: "https://static01.nyt.com/images/2024/04/10/multimedia/00dc-vpresidence-01-hcgv/00dc-vpresidence-01-hcgv-videoSixteenByNine3000.jpg",
    ...
    {
      link: "/your-link-url",
      imageSrc: "https://images.mansionglobal.com/im-36465838",
  ...
  return (
    <div>
      <h2 className="pl-3.5 pt-6 pb-2 text-4xl font-bold">Contenu payant</h2>
