...
function SeventhSection() {
  const midCards = [
    {
      link: "/your-link-url",
      imageSrc: "https://images.bfmtv.com/6A36VzaA9uIMRwpQluSiLC87kvw=/0x0:1280x720/images/Marine-Le-Pen-Il-faudra-bien-a-un-moment-donne-qu-Emmanuel-Macron-se-soumette-au-debat-d-idees-1360041.jpg",
      text: "Le Pen ramps up Haley criticism as he rejects calls to exit GOP primary",
      tag: "",
    },
  ...
  const midCards2 = [
    {
      link: "/your-link-url",
      imageSrc: "https://images.bfmtv.com/FOEF9moexTpV-MLpZbcFS1hinkk=/0x0:1024x576/1024x0/images/Jean-Luc-Melenchon-invite-de-BFMTV-dimanche-23-janvier-2022-1221368.jpg",
  ...
  const midCards3 = [
    {
      link: "/your-link-url",
      imageSrc: "https://images.bfmtv.com/mvXtB49ObOW4uEIhMM3Wyd_U5vs=/0x0:1280x720/860x0/images/Snapchat-lance-My-AI-un-chatbot-base-sur-ChatGPT-1625478.jpg",
    ...
    <div>
      <div className="flex flex-wrap">
        ...
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4">
          <ColumnHead columnHeadTag="POLITIQUE FRANCE" />
        ...
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4">
          ...
          <ColumnHead columnHeadTag="SCIENCES ET SANTÉ" />
